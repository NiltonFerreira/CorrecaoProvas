...
public class CorreçãoProvas {
    ...
    public static void main(String[] args) throws Exception {
        ...
        professor1 = facade.buscarProfessor(8l);
        professor2 = facade.buscarProfessor(9l);
        professor3 = facade.buscarProfessor(10l);
        System.out.println(professor1);
        System.out.println(professor2);
        System.out.println(professor3);
        System.out.println(facade.buscarAluno(10l));
        System.out.println(facade.buscarAluno(11l));
        System.out.println(facade.buscarAluno(12l));
        turma = facade.buscarTurma(4l);
